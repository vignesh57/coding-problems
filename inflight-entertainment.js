...
//flightLength - 220
//movieLengths - [90,180,110,130,160,190,40]

var canTwoMoviesFillFlight = function(movieLengths, flightLength){
    //let titles = [];
    //create map
    ...
    for(var i = 0; i < movieLengths.length; i++){
        if(database.has(flightLength - movieLengths[i]) )
            return true;
        else database.add(movieLengths[i]);
    }
    return false;
}
/*
var canTwoMoviesFillFlight = function(flightLength,movieLengths){
    ...
    for (let i = 0; i < movieLengths.length; i++){
      ...
      console.log(`>>We have ${firstMovieLength} Find a ${matchingSecondMovieLength}`);
      if (movieLengthsSeen.has(matchingSecondMovieLength)){
        return true;
      }
  
      movieLengthsSeen.add(firstMovieLength);
      console.log("--",movieLengthsSeen, movieLengthsSeen.size);
    }
...
*/  
//console.log(    canTwoMoviesFillFlight(381, [90,180,110,130,160,190,40,190]) );
